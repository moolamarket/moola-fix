...
import { default as celoTransfer } from './fd-celo-transfer'
import { default as celoRegistry } from './ce10-celo-registry'
...
const precompiles: Precompiles = {
  ...
  '00000000000000000000000000000000000000fd': celoTransfer,
  '000000000000000000000000000000000000ce10': celoRegistry,
}
